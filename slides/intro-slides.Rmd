...
date: "Poznan, 2017 - more material: rpubs.com/robinlovelace"
output:
...
## Agenda | see github.com/robinlovelace/cs7

- Intro to intermediary R
- Basics of R as a GIS
- Advanced map making
...
- How good are its functions?
- Does it have vignettes?
- What are alternative packages?
- Is it the best 'tool for the job'?

## An introduction to classes

- 45 minute practical on vectors and lists ([Chapter 20 of R4DS](http://r4ds.had.co.nz/vectors.html)):
...
- Challenge: Create a list containing logical, numeric and character vectors.
  - What happens when you `unlist()` this list?
